...
export default function SignupPage() {
  return (
    <main className="mx-auto max-w-xl px-4 py-16 sm:px-6">
      <SectionHeading kicker="Onboarding" title="Create a Via account" description="Passengers, logistics users, conductors, and admins all use the same identity system with role-aware routing." />
